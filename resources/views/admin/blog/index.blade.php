            ...
            <div class="card-body">
                ...
                <div class="table-responsive no-wrap">
                    <table class="table" id="datatable">
                        <x-table.header :headers="['image','title', 'publish date', 'phase', 'Actions']" />
...
<script>
    $(document).on('show.bs.modal', '.modal', function(event) {
        ...
        let url = "{{ route('admin.blogs.show', ':id') }}".replace(':id', contactId);
    ...
    @include('_helpers.yajra', ['url' => route('admin.blogs.index'), 'columns' => $columns])
    @include('_helpers.swal_delete')
    @include('_helpers.status_change', ['url' => route('admin.blogs.status')])
