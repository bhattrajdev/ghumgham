            ...
            <li class="list-group-item">
                ...
                <div class="d-flex flex-column mt-2">
                    <div class="bg-light p-3 rounded border">
                        <p class="mb-1"><strong>Name:</strong> <span class="fw-semibold">{{ $blog->user->name }}</span></p>
                        <p class="mb-0"><strong>Email:</strong> <span class="fw-semibold">{{ $blog->user->email }}</span></p>
                        <p class="mb-0"><strong>Role:</strong> <span class="fw-semibold">{{ $blog->user->role }}</span></p>
                    </div>
                </div>
            </li>
        </ul>
